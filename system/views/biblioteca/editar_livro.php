        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="titulo" aria-describedby="basic-addon1" value="<?php echo $livros['titulo']; ?>">
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="isbn" required aria-describedby="basic-addon1" value="<?php echo $livros['isbn']; ?>">
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="autor"  required aria-describedby="basic-addon1" value="<?php echo $livros['autor']; ?>">
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="edicao" name="edicao"  required aria-describedby="basic-addon1" value="<?php echo $livros['edicao']; ?>" >
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="editora" name="editora"  required aria-describedby="basic-addon1"  value="<?php echo $livros['editora']; ?>" >
                </div>
            </div>    
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" id="data_edicao" aria-describedby="basic-addon1" value="<?php echo $livros['data_edicao']; ?>">
                </div>
            </div>
                       ...
                       url: '../../engine/controllers/livros.php',
                            ...
                            success: function(data) {
                                console.log(data);
                                 ...
                                 if(data === 'true'){
                                    swal("Sucesso", "Livro  Editado!", "success");
