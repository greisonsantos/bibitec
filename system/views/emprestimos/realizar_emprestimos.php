  ...
  <div id="wrapper">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      ...
      <section class="container-fluid text-center main-screen">    
            ...
            <div class="col-lg-12" style="margin-top: 20px;">
              <form style="text-align: right;" method="GET" id="pesqisa">
                <div class="input-group">
                  <input type="text" class="form-control" id="ValorPesquisaCli" name="ValorPesquisa" placeholder="Pesquisar por ..." style="border-radius: 5px;">
                  <div class="input-group-btn">
                    <select class="btn btn-default dropdown-toggle" name="tipocli" id="tipocli" style="font-family: Montserrat, Helvetica, Arial, sans-serif; font-weight: 600; border-radius: 5px; padding: 7px;">
            <!--           <option value="cpf" selected>Cpf</option> -->
                      <option value="cpf">Cpf CLiente</option>
                    </select>
                  </div><!-- /btn-group -->
                  <div class="input-group-btn">
                    <button class="btn btn-success" type="button" id="buscar_cliente" style="border-radius: 20%;"><span class="glyphicon glyphicon-search"></span></button>
                  </div><!-- /btn-group -->
                </div><!-- /input-group -->
              </form>
            </div><!-- /.col-lg-6 -->
        ...
        <section class="row">
          ...
          <section class="col-md-6">
            <br>
            <div class="input-group">
              <span class="input-group-addon">Nome do Livro *</span>
            ...
            <input type="hidden" name="data_emprestimo" id="data_emprestimo" value="<?php echo date('Y/m/d')?>">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <br><br>
            <button type="button" id="emprestar" class="btn btn-primary btn-block">Emprestar</button>
          </div>
          <div class="col-md-3"> </div>
        </div>
      ...
      <script type="text/javascript">
        ...
        $("#ValorPesquisaCli").mask("999.999.999.99");
         ...
         $('#buscar_cliente').click(function(e) {
          e.preventDefault();    

          var valorpesquisacli= $('#ValorPesquisaCli').val();
          

          if (!valorpesquisacli) {
               return swal("Atenção", "Insira o nome no campo de pesquisa !", "error");
            ...
            $.ajax({
              ...
              success : function(data){
                ...
                if (obj.res == 'true') {
                   ...
                   document.getElementById("id_cli").value = obj.id_cli;
                   document.getElementById("nome_cli").value = obj.nome_cli;

                  swal("Sucesso", "Usuario Encontrado!", "success");
                } else {
                  swal("Atenção", "Usuario não encontrado! Tente novamente.", "error");
                }
              },
              type : 'POST'
            });
            ...
            $.ajax({
              ...
              success : function(data){
                ...
                if (obj.res == 'true') {
                    ...
                    if(obj.status=='1'){
                      return swal("Atenção", "Este Livro esta emprestado !", "info");
                    }else{ 
    ...
    $('#emprestar').click(function(e) {
       ...
       $(this).attr('disabled', true); 
           ...
           if (!cpf || !titulo){
                 swal("Atenção", "O campo Cpf  é Titulo devem ser informado.", "error");
        
           }else {
                  $.ajax({
                       url: '../../engine/controllers/emprestimos.php',
                            data: {
                       ...
                       url: '../../engine/controllers/livros.php',
                            ...
                            success: function(data) {
                                console.log(data);
                                 ...
                                 if(data === 'true'){
                                    swal("Sucesso", "Livro  Emprestado !", "success");
