...
<body>
    ...
    <section class="container-fluid text-center main-screen">    
     <div class="row">
      <div class="col-md-12">
        <div class="col-md-6">
            <a href="realizar_emprestimos.php">  
              <div class="col-md-8 col-xs-6  fundo">
               <i class="fa fa-angle-double-down fa-5x"></i>
               <h4 class="text-center"> Realizar Emprestimo</h4>
           </div>
       </a>    
     </div>

   <div class="col-md-6" >
    <a href="realizar_devolucao.php">  
      <div class="col-md-8 col-xs-6 fundo" >
...
<div class="row">
        ...
        <div class="col-md-6">
            <a href="cadastro_livro.php">  
              <div class="col-md-8 col-xs-6  fundo">
               ...
               <h4 class="text-center"> Lista de Emprestimos</h4>
           </div>
       </a>    
     </div>
   ...
   <div class="col-md-6" >
    <a href="consultar_livro.php">  
      <div class="col-md-8 col-xs-6 fundo" >
        <i class="fa fa-navicon fa-5x"></i>
        <h4 class="text-center">Lista de Devolução</h4>
      </div>
    </a>    
   </div>
</div>
